...
type ReporDetailedUseCaseRequest = {
  userId: string;
};

type ReporDetailedUseCaseResponse = Either<null, ReporDetailedProps>;

type ReporDetailedProps = {
...
@Injectable()
export class ReporDetailedUseCase {
  constructor(private prisma: PrismaService) {}

  async execute({
    userId,
  }: ReporDetailedUseCaseRequest): Promise<ReporDetailedUseCaseResponse> {
